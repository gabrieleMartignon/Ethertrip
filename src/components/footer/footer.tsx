...
export default function Footer() : ReactElement {
    return (
        <div className="flex justify-center items-center h-[20vh] ">
            <div className="h-[10vh] w-[85vw] bg-[#f5e6d3]  shadow-md opacity-90 rounded-xl font-montserrat flex justify-evenly items-center font-semibold">
